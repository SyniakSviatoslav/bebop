...
use crate::pq_dsa::{keygen_bytes, sign_internal_bytes, verify_internal_bytes, SEEDBYTES};

const KAT_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/kat/acvp/");
...
mod diag {
    use super::*;
    use crate::pq_dsa::{unpack_pk_bytes, unpack_sig_bytes};
